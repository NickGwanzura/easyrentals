...
import { generatePaymentReportPDF, downloadPDF } from '@/lib/pdfExport';
...
export default function PaymentsPage() {
  ...
  const handleExportPDF = async () => {
    ...
    try {
      const stats = { totalPaid, totalOutstanding, totalPayments: payments.length };
      const pdf = generatePaymentReportPDF(filteredPayments, stats, demoData);
      downloadPDF(pdf, 'payments-report');
