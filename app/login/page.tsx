        ...
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <div className="max-w-md text-white">
            <blockquote className="text-2xl font-medium leading-relaxed mb-6">
              &ldquo;EazyRentals has completely transformed how I manage my rental properties in Zimbabwe. 
              The dashboard is intuitive and saves me hours every week.&rdquo;
            </blockquote>
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full bg-white/20 flex items-center justify-center">
                <span className="text-lg font-semibold">TJ</span>
              </div>
              <div>
                <p className="font-semibold">Tendai Jambwa</p>
                <p className="text-primary-200">Property Manager, Harare</p>
              </div>
            </div>
          </div>
        </div>
