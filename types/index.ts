...
export type LeaseReviewStatus = 'pending' | 'completed' | 'overdue' | 'flagged';
export type LeaseComplianceRating = 'excellent' | 'good' | 'fair' | 'poor' | 'critical';
...
export interface LeaseReview {
  ...
  // Payment Performance
  rentPaidOnTime: number; // percentage
  latePayments: number;
  missedPayments: number;
  totalPaymentsDue: number;
  
  // Compliance
  complianceRating: LeaseComplianceRating;
  leaseViolations: string[];
  maintenanceRequests: number;
  
  // Property Condition
  propertyCondition: LeaseComplianceRating;
  conditionNotes?: string;
  
  // Tenant Behavior
  tenantBehavior: LeaseComplianceRating;
  behaviorNotes?: string;
  
  // Recommendations
  recommendRenewal: boolean;
  renewalNotes?: string;
  rentAdjustment?: number; // percentage
